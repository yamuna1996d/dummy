...
class CustomDropdownField<T> extends StatelessWidget {
  ...
  String _textFor(T? value) {
    if (value == null) return hint ?? 'Not selected';
                ...
                Builder(
                  builder: (context) {
                    ...
                    return Semantics(
                      button: true,
                      label: itemText,
                      hint: isSelected ? 'Currently selected' : null,
  ...
  Widget build(BuildContext context) {
    return FormField<T>(
      ...
      builder: (state) {
        ...
        final semanticsLabel = '$fieldLabel. Currently selected: $displayText';
        const semanticsHint = 'Opens a picker to choose a different value';
